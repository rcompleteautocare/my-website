    ...
    <div style={{ color: "#1a1a1a" }}>
      ...
      <section style={{ background: "#1a1a1a", color: "#fff", padding: "60px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "18px", color: "#ccc", maxWidth: "600px", margin: "0 auto 32px" }}>
          Cedar Lake drivers trust R Complete Auto Care in Crown Point for honest diagnostics and expert auto repair.
        </p>
      ...
      <section style={{ padding: "60px 24px", maxWidth: "800px", margin: "0 auto" }}>
        <h2 style={{ fontSize: "28px", marginBottom: "16px" }}>Serving Cedar Lake, IN Drivers</h2>
        <p style={{ lineHeight: 1.8, color: "#444", marginBottom: "24px" }}>
          R Complete Auto Care is located just minutes from Cedar Lake, Indiana at 1305 E Summit St in Crown Point. We're a diagnostic-first auto repair shop serving drivers throughout Lake County and Northwest Indiana. We work on all foreign and domestic vehicles and accept most extended warranty plans.
        </p>
        <p style={{ lineHeight: 1.8, color: "#444", marginBottom: "40px" }}>
          We find the real problem before recommending any repair — so you only pay for what you actually need. No guesswork, no upselling, just honest answers and expert repairs.
        </p>

        <h2 style={{ fontSize: "28px", marginBottom: "24px" }}>Services for Cedar Lake Drivers</h2>
        ...
        {[
          { q: "How far is R Complete Auto Care from Cedar Lake?", a: "We're located about 10 minutes from Cedar Lake at 1305 E Summit St in Crown Point, IN." },
      ...
      <section style={{ background: "#e63946", color: "#fff", textAlign: "center", padding: "60px 24px" }}>
        <h2 style={{ fontSize: "28px", marginBottom: "12px" }}>Cedar Lake Drivers Welcome!</h2>
