  ...
  return (
    <div style={{ color: "#1a1a1a" }}>
      ...
      <section style={{ padding: "60px 24px", maxWidth: "800px", margin: "0 auto" }}>
        ...
        <p style={{ lineHeight: 1.8, color: "#444", marginBottom: "20px" }}>
          Many of our Cedar Lake customers first came in after receiving a major repair recommendation somewhere else. We&apos;d rather find the verified fault than sell an assembly the vehicle does not need — and when the repair genuinely is major, we show you the diagnostic data and walk you through the options. For lake-country drivers who depend on their vehicle to tow, haul, or just get to work in Crown Point or Merrillville, straight answers matter more than glossy waiting rooms.
        </p>
...
/>
    ...
    <ServiceSchema name="Auto Repair Near Cedar Lake, IN" serviceType="Auto repair" path="/auto-repair-cedar-lake-in" />
  </div>
  );
}
