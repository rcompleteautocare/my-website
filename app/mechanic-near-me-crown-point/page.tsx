...
export const metadata = {
  ...
  description: `Looking for a mechanic in Crown Point, IN? R Complete Auto Care is a top-rated diagnostic-first auto repair shop. ${RATING} stars. (219) 262-2711.`,
    ...
    <div style={{ color: "#1a1a1a" }}>
      ...
      <section style={{ background: "#f5f5f5", padding: "32px 24px" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "16px", textAlign: "center" }}>
          {[
            { icon: "⭐", stat: `${RATING} Stars`, label: "Google Rating" },
      ...
      <section style={{ background: "#e63946", color: "#fff", textAlign: "center", padding: "60px 24px" }}>
        ...
        <p style={{ marginBottom: "8px", opacity: 0.9 }}>{RATING} Stars · Diagnostic-First · Extended Warranty Accepted · Same-Day Available</p>
