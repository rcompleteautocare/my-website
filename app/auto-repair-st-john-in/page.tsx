...
<p style={{ lineHeight: 1.8, color: "#444", marginBottom: "40px" }}>
  We see a regular pattern of vehicles from St. John with extended warranty coverage through dealership-sold plans from the US-41 corridor dealerships. If you purchased a vehicle from one of those dealers and have a warranty through Zurich or a similar provider, we work with those plans directly. Call us with your contract number before you bring it in.
        ...
        {[
          { q: "Where is the best auto repair shop near St. John, IN?", a: "R Complete Auto Care at 1305 E Summit St, Crown Point, IN 46307 — just about 10 minutes from St. John. Call (219) 262-2711." },
          { q: "How far is R Complete Auto Care from St. John?", a: "We're located about 10 minutes from St. John, Indiana at 1305 E Summit St in Crown Point, IN 46307." },
          { q: "Do you accept extended warranties for St. John drivers?", a: "Yes! We work with most extended warranty providers and handle the entire claims process. St. John drivers are welcome — just give us a call at (219) 262-2711." },
          ...
          { q: "Do you offer same-day service for St. John drivers?", a: "Yes — most diagnostic appointments and many repairs are completed the same day. Call us at (219) 262-2711 to schedule." },
        ].map(item => (
