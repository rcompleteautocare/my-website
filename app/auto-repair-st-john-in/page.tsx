    ...
    <div style={{ color: "#1a1a1a" }}>
      ...
      <section style={{ background: "#1a1a1a", color: "#fff", padding: "60px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "18px", color: "#ccc", maxWidth: "600px", margin: "0 auto 32px" }}>
          St. John drivers trust R Complete Auto Care in Crown Point for honest diagnostics and expert auto repair.
        </p>
      ...
      <section style={{ padding: "60px 24px", maxWidth: "800px", margin: "0 auto" }}>
        <h2 style={{ fontSize: "28px", marginBottom: "16px" }}>Serving St. John, IN Drivers</h2>
        <p style={{ lineHeight: 1.8, color: "#444", marginBottom: "24px" }}>
          R Complete Auto Care is located just minutes from St. John, Indiana at 1305 E Summit St in Crown Point. We're a diagnostic-first auto repair shop serving drivers throughout Lake County and Northwest Indiana — including St. John, Dyer, Lowell, and the surrounding communities.
        </p>
        <p style={{ lineHeight: 1.8, color: "#444", marginBottom: "40px" }}>
          We work on all foreign and domestic vehicles and accept most extended warranty plans. Bring your vehicle to us for honest answers and expert repairs.
        </p>

        <h2 style={{ fontSize: "28px", marginBottom: "24px" }}>Services for St. John Drivers</h2>
        ...
        {[
          { q: "How far is R Complete Auto Care from St. John?", a: "We're located about 10 minutes from St. John at 1305 E Summit St in Crown Point, IN." },
      ...
      <section style={{ background: "#e63946", color: "#fff", textAlign: "center", padding: "60px 24px" }}>
        <h2 style={{ fontSize: "28px", marginBottom: "12px" }}>St. John's Trusted Auto Repair Shop</h2>
