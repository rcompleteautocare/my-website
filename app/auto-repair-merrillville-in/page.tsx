    ...
    <div style={{ color: "#1a1a1a" }}>
      ...
      <section style={{ background: "#1a1a1a", color: "#fff", padding: "60px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "18px", color: "#ccc", maxWidth: "600px", margin: "0 auto 32px" }}>
          Merrillville drivers trust R Complete Auto Care in Crown Point for honest diagnostics and expert auto repair.
        </p>
      ...
      <section style={{ padding: "60px 24px", maxWidth: "800px", margin: "0 auto" }}>
        <h2 style={{ fontSize: "28px", marginBottom: "16px" }}>Serving Merrillville, IN Drivers</h2>
        <p style={{ lineHeight: 1.8, color: "#444", marginBottom: "24px" }}>
          R Complete Auto Care is located just minutes from Merrillville, Indiana at 1305 E Summit St in Crown Point. We're a diagnostic-first auto repair shop serving drivers throughout Lake County and Northwest Indiana. We work on all foreign and domestic vehicles and accept most extended warranty plans.
        </p>
        <p style={{ lineHeight: 1.8, color: "#444", marginBottom: "40px" }}>
          Whether you need a check engine light diagnosed, brakes replaced, or a major engine repair, our technicians have the expertise to get it done right — at a fair price.
        </p>

        <h2 style={{ fontSize: "28px", marginBottom: "24px" }}>Services for Merrillville Drivers</h2>
        ...
        {[
          { q: "How far is R Complete Auto Care from Merrillville?", a: "We're located about 10 minutes from Merrillville at 1305 E Summit St in Crown Point, IN." },
      ...
      <section style={{ background: "#e63946", color: "#fff", textAlign: "center", padding: "60px 24px" }}>
        <h2 style={{ fontSize: "28px", marginBottom: "12px" }}>Merrillville Drivers Welcome!</h2>
