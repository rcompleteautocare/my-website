    ...
    <div style={{ color: "#1a1a1a" }}>
      ...
      <section style={{ background: "#1a1a1a", color: "#fff", padding: "60px 24px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "18px", color: "#ccc", maxWidth: "600px", margin: "0 auto 32px" }}>
          R Complete Auto Care is Crown Point's trusted diagnostic-first auto repair shop. Honest estimates, expert repairs, extended warranty work welcome.
        </p>
      ...
      <section style={{ padding: "60px 24px", maxWidth: "800px", margin: "0 auto" }}>
        ...
        <p style={{ lineHeight: 1.8, color: "#444", marginBottom: "40px" }}>
          We work on all foreign and domestic vehicles and proudly accept most extended warranty plans. Whether you need a check engine light diagnosed, brakes replaced, or a major engine repair, we have the expertise to get it done right.
        </p>

        <h2 style={{ fontSize: "28px", marginBottom: "24px" }}>Our Services in Crown Point</h2>
        ...
        <div style={{ background: "#f9f9f9", borderRadius: "8px", padding: "32px", marginBottom: "40px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "24px" }}>
            ...
            <div>
              ...
              <div style={{ lineHeight: 1.8 }}><a href="tel:2192622711" style={{ color: "#1a1a1a" }}>(219) 262-2711</a></div>
            </div>
          </div>
        </div>
        ...
        {[
          { q: "Where is R Complete Auto Care located in Crown Point?", a: "We're located at 1305 E Summit St, Crown Point, IN 46307. Easy to find and conveniently located for drivers throughout Lake County." },
      ...
      <section style={{ background: "#e63946", color: "#fff", textAlign: "center", padding: "60px 24px" }}>
        ...
        <p style={{ marginBottom: "24px", opacity: 0.9 }}>Call us today or stop by. Honest diagnostics, expert repairs.</p>
