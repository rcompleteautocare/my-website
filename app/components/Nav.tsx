...
export default function Nav() {
  ...
  return (
    <>
        ...
        <nav style={{ display: "flex", gap: "24px", alignItems: "center", fontSize: "15px" }} className="desktop-nav">
          ...
          <div ref={servicesMenuRef} style={{ position: "relative" }}
            ...
            <button
              ...
              style={{ cursor: "pointer", color: "#1a1a1a", fontWeight: "500", border: 0, padding: "8px 0", background: "transparent", font: "inherit" }}
            >
            ...
            <div id="desktop-services-menu" style={{ display: servicesOpen ? "block" : "none", position: "absolute", top: "100%", left: 0, background: "#fff", border: "1px solid #e0e0e0", borderTop: "3px solid #e63946", minWidth: "240px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", zIndex: 200 }}>
              {services.map(s => (
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div id="mobile-navigation" style={{ background: "#fff", borderBottom: "2px solid #e63946", zIndex: 99, position: "relative" }} className="mobile-menu">
          <div style={{ padding: "8px 0" }}>
            ...
            <div>
              ...
              {servicesOpen && (
                <div id="mobile-services-menu" style={{ background: "#f9f9f9" }}>
                  {services.map(s => (
